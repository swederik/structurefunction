def scale_PVC_matrix_fn(subject_id, in_file, dose_mCi, weight_kg, delay_min, scan_time_min=15, isotope="F18", glycemie=None):
    ...
    for method in methods:
        ...
        T = (delay_min_min + scan_time_min_min) * 60
...
def CMR_glucose(subject_id, in_file, dose_mCi, weight_kg, delay_min, glycemie, scan_time_min=15):
    '''
...
def calculate_SUV(subject_id, in_file, dose_mCi, weight_kg, delay_min, scan_time_min=15, isotope="F18", height=None, glycemie=None):
    '''
